    ...
    <div class="container-fluid">
        ...
        <div class="card kartu-custom mb-5">
            <div class="card-header">
                <p class="m-0 p-0 text-white"><b>Data Gejala</b></p>
            </div>
            <div class="card-body">
                ...
                @endif
                <a href="{{ URL::to('data-gejala/create') }}" class="btn btn-custom-2 mb-3">
                ...
                <table class="table table-bordered custom-table" id="responsive-table">
                    ...
                    <tbody>
                        @php
                            $i = 1;
                        @endphp
                        @foreach ($dataGejala as $listGejala)
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    ...
                                    <form action="{{ URL::to('data-gejala/' . $listGejala->id_gejala) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
