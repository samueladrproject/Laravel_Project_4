    ...
    <div class="container-fluid">
        ...
        <div class="card kartu-custom mb-5">
            <div class="card-header">
                <p class="m-0 p-0 text-white"><b>Data Basis Pengetahuan</b></p>
            </div>
            <div class="card-body">
                ...
                @endif
                <a href="{{ URL::to('data-basis-pengetahuan/create') }}" class="btn btn-custom-2 mb-3">
                        ...
                        @foreach ($dataBasisPengetahuan as $listBasisPengetahuan)
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    ...
                                    <form
                                        action="{{ URL::to('data-basis-pengetahuan/' . $listBasisPengetahuan->id_basis_pengetahuan) }}"
