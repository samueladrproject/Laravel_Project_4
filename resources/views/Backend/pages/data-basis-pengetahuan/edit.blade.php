    ...
    <div class="container-fluid">
        ...
        <div class="card kartu-custom mb-5">
            <div class="card-header">
                <p class="m-0 p-0 text-white"><b>Ubah Data Basis Pengetahuan</b></p>
            </div>
            <div class="card-body">
                <form action="{{ URL::to('data-basis-pengetahuan/' . $idBasisPengetahuan) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <select class="form-select" id="kode_penyakit" name="kode_penyakit">
                                ...
                                @foreach ($dataPenyakit as $penyakit)
                                    @if (old('kode_penyakit', $dataBasisPengetahuan['kode_penyakit']) == $penyakit->kode_penyakit)
